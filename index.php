    ...
    <div id="wrapper" class="wrapper">
        ...
        <section id="section1">
            <div class="row">
                ...
                <div class="col-md-4 col-sm-4 col-xs-12 one">
                    <div class="box2 info">
                        <h3 class="title">板块分类<a href="#" target="_self"></a></h3>
                        <p>二手交易---校园二手平台<a href="secondHands/index/secondHands.php" target="_blank">GO</a></p>
                        <p>失物招领---发布各种失物招领消息<a href="http://219.153.130.77:8094/qt/find/" target="_blank">GO</a></p>
                ...
                <div class="col-md-4 col-sm-4 col-xs-12 one">
                  ...
                  <?php 
                    ...
                    while ($data = mysqli_fetch_object($result)) {
                     ?>
                     <p><?php echo $data->friendly_link_name;?><a href="<?php echo $data->friendly_link_url;?>" target="_blank">GO</a></p>
                    <?php }?>
                    </div>
                </div>
